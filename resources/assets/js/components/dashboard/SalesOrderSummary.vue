...
<div class="box">
            ...
            <div class="dropdown is-right" v-bind:class="{ 'is-active': isProfileDropdownActive }">
                ...
                <div class="dropdown-menu" id="dropdown-menu" role="menu">
                    <div class="dropdown-content">
                        <a id="today" @click="click_menu" href="javascript:void(0)" class="dropdown-item">
                            Today
                        </a>
    ...
    <table class="table is-fullwidth">
        ...
        <tr>
            ...
            <td class="table_head" style="padding-top:20px;border:none"> Total Sales</td>
        </tr>
...
export default {
    ...
    methods: {
        ...
        fetch_data: function (vfrom, vto) {
            ...
            axios.post('api/dashboard/salesordercount', payload)
                .then(response => {
        ...
        loadPurchaseOrderSum: function (vfrom, vto) {
            ...
            axios.post('api/dashboard/salesordertotal', payload)
                .then(response => {
