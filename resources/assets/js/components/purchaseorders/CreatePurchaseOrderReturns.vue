        ...
        <th> </th>
         ...
         <tbody>
          ...
          <tr v-for="(product, index) in product_grid">
            ...
            <td>{{product.name}} </td>
            <td><input v-model='product_grid[index].productprice.purchase_price' /> </td>
            <td> <input v-model='product_grid[index].qty' /> </td>
            <td> {{product_grid[index].productprice.purchase_price*product_grid[index].qty}}</td>
